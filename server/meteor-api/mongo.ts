import type { Document, IndexSpecification, CreateIndexesOptions, CountDocumentsOptions, EstimatedDocumentCountOptions, Db } from "mongodb";
import type * as types from '../../shared/meteor-types/mongo.d.ts';
// import { RandomStream } from "jsr:@dist-app/stdlib@0.1.5/ddp/random";
