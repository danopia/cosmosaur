...
import type { Meteor } from './meteor.d.ts';
import type { DDP } from './ddp.d.ts';
...
export namespace Mongo {
  ...
  type Modifier<T> = UpdateFilter<T>;
  ...
  interface Collection<T extends Document, U = T> {
     ...
     */
    countDocuments(selector?: Selector<T> | ObjectID | string, options?: CountDocumentsOptions): Promise<number>;
    /**
